...
message = tk.Label(window, text="Automated Class Attendance System with Face Recognition" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, 'italic bold underline')) 
...
copyWrite.insert("insert", "Sourabh")
